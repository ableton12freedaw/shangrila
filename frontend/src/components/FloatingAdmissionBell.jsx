  ...
  return (
    <>
      <button
        ...
        className="floating-bell-pulse fixed bottom-6 right-5 z-[90] flex flex-col items-center gap-1 rounded-2xl bg-gradient-to-b from-[#1e88e5] to-[#1a237e] px-5 pb-3 pt-4 text-white shadow-[0_6px_28px_rgba(26,35,126,0.5)] transition-transform hover:scale-105"
        data-testid="floating-admission-bell-button"
        aria-label="Open admission enquiry form"
      >
        <span className="floating-bell-ring -mt-9 mb-1 inline-flex rounded-full border-[3px] border-white bg-white p-3 shadow-md">
          <Bell className="h-7 w-7 text-amber-500" strokeWidth={2.5} />
        </span>
        <span className="text-center text-xs font-bold leading-snug tracking-wide">
