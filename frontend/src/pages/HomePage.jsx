    ...
    <>
      <section className="relative overflow-hidden" data-testid="home-hero-section">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-[#050c22]/80 via-[#0b163a]/58 to-[#fdfbf7]" />
        ...
        <div className="relative mx-auto flex min-h-[72vh] max-w-7xl items-end px-4 pb-10 pt-24 sm:min-h-[80vh] sm:px-6 sm:pb-16 sm:pt-32 lg:px-8">
          ...
          >
            ...
            <h1 className="text-3xl font-black leading-tight text-white drop-shadow-[0_3px_14px_rgba(0,0,0,0.95)] sm:text-5xl lg:text-6xl" data-testid="home-main-heading">
              {schoolIdentity.name}
            </h1>
            <p className="mt-4 max-w-2xl text-sm leading-7 text-white drop-shadow-[0_2px_10px_rgba(0,0,0,0.9)] sm:text-lg sm:leading-8" data-testid="home-tagline-text">
